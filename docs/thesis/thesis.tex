...
%
\title{Nghiên cứu và thiết kế hệ thống Bridge Blockchain theo hướng tiếp cận Intent-based và mạng ngang hàng P2P}	%% title
\author{Trần Anh Đức}			%% author's name
...
% Chapter 5 (cài đặt và kiểm thử) đã gộp vào Chương 4 (Cài đặt, kiểm thử và triển khai)
% \input{chapters/c5/c5_chapter}\newpage\cleardoublepage
...
% NOTE: commented out during setup — this is a second \bibliographystyle after
% \bibliography{} which writes a duplicate \bibstyle to the .aux file and
% causes bibtex to error. The real style is set at line 43 (unsrt).
