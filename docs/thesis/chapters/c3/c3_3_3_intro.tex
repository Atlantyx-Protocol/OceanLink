...
Mục 3.2 đã trình bày kiến trúc tổng quan và đặt mỗi thành phần vào một vị trí trên sơ đồ off-chain/on-chain; Mục~\ref{sec:three-layer-model} bổ sung góc nhìn chiến lược thực thi bằng mô hình ba lớp Netting $\rightarrow$ Accelerator $\rightarrow$ Fallback. Hai mục đó trả lời các câu hỏi ``hệ thống có những gì'' và ``một intent đi qua đâu trước, đâu sau''.
